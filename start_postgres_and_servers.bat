...
echo Starting Unified Portal Server on Port 8000...
start "ShowAnswer Unified Portal Server (Port 8000)" cmd /k "cd QuestionScannerProject && set DATABASE_URL=%DATABASE_URL% && python start_app.py"
